...
Each project owns a key prefix (e.g. WORK) and hands out ticket numbers from its own
counter, so goals read as WORK-12. Goals don't store the prefix — the key is always
